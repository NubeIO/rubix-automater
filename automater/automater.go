...
type JobService interface {
	Create(name, taskName, subTaskName, description string, ScheduleAt string, timeout int, disable bool, options *model.JobOptions, taskParams map[string]interface{}) (*model.Job, error)
